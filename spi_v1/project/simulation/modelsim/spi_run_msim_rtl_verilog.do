...
vlog -vlog01compat -work work +incdir+E:/opendev_fpga/spi_v1/module {E:/opendev_fpga/spi_v1/module/spi_module.v}

vlog -vlog01compat -work work +incdir+E:/opendev_fpga/spi_v1/project/../simulation {E:/opendev_fpga/spi_v1/project/../simulation/spi_module_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  spi_module_tb
